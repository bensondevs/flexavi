...
return [
     ...
     * absolute url.
     */
    'webhook_url' => env('NGROK_URL', env('APP_URL')) . '/mollie/webhooks/payment',

    /**
     * The default aftercare webhook url is called by Mollie on refunds and chargebacks. You can use either a relative or
     * absolute url.
     */
    'aftercare_webhook_url' => env('NGROK_URL', env('APP_URL')) . '/mollie/webhooks/aftercare',
    ...
    'first_payment' => [
         ...
         */
        'webhook_url' => env('NGROK_URL', env('APP_URL')) . '/mollie/webhooks/first_payment',
        ...
        'amount' => [
             ...
             * your Mollie account.
             */
            'currency' => \App\Enums\Currency::EUR,
        ],
