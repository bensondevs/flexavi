...
class CrudGenerator extends Command
{
    ...
    protected $signature = 'crud:generate
                            ...
                            {--controller=false : whether want to use controller or not, use true or false}
                            {--model=true : whether want to use model or not, use true or false}
                            {--migration=false : whether want to use migration or not, use true or false use true or false}
    ...
    protected function model($name)
    {
        $modelTemplate = str_replace([
            ...
            [
                $name,
                $this->toSnakeCase(Str::plural($name)),
    ...
    {
        $migrationTable = $this->toSnakeCase(Str::plural($name));
    ...
    protected function view($name)
    {
        ...
        $folderName = $this->toSnakeCase(Str::plural($name));
    ...
    protected function route($name)
    {
        ...
        $uri = $this->toSnakeCase(Str::plural($name));
