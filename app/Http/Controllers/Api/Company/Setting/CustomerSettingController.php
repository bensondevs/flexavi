...
use App\Http\Requests\Company\Settings\UpdateCustomerSettingRequest as UpdateRequest;
...
class CustomerSettingController extends Controller
{
    ...
    {
        $this->settingRepository = new GeneralSettingRepository(CustomerSetting::class);
    }
    ...
    {
        $setting = SettingService::find($request->getCompany(), SettingModule::Customer);
