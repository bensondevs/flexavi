...
class ChangeStatusWorkServiceRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $this->user()
            ->fresh()
            ->can('edit-work-service', $workService);
    }
    ...
    /**
     * Get the change status request data
     *
     * @return int
     */
    public function getChangeStatus(): int
    {
        $workService = $this->getWorkService();

        return $workService->isActive() ? WorkServiceStatus::Inactive : WorkServiceStatus::Active;
    }
}
