...
class CostPolicy
{
    ...
    {
        return $user->hasPermissionTo('view any costs');
    }
    ...
    {
        return $user->hasCompanyPermission($cost->company_id, 'view costs');
    }
    ...
    public function record(User $user, Cost $cost, $costable)
    {
        ...
        return $user->hasCompanyPermission($cost->company_id, 'record costs');
    }
    ...
    {
        return $user->hasCompanyPermission($costable->company_id, 'record costs');
    }
    ...
    public function unrecord(User $user, Cost $cost, $costable)
    {
        ...
        return $user->hasCompanyPermission($cost->company_id, 'unrecord costs');
    }
    ...
    {
        return $user->hasCompanyPermission($costable->company_id, 'unrecord costs');
    }
    ...
    {
        return $user->hasCompanyPermission($costable->company_id, 'truncate costs');
    }
    ...
    {
        return $user->hasCompanyPermission($cost->company_id, 'edit costs');
    }
    ...
    {
        return $user->hasCompanyPermission($cost->company_id, 'delete costs');
    }
    ...
    {
        return $user->hasCompanyPermission($cost->company_id, 'restore costs');
    }
    ...
    {
        return $user->hasCompanyPermission($cost->company_id, 'force delete costs');
    }
}
