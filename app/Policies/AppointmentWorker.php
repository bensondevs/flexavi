...
class AppointmentWorker
{
    ...
    {
        return $user->hasCompanyPermission($appointment->company_id, 'view any appointment workers');
    }
    ...
    {
        return $user->hasCompanyPermission($appointment->company_id, 'create appointment workers');
    }
    ...
    {
        return $user->hasCompanyPermission($appointmentWorker->company_id, 'edit appointment workers');
    }
    ...
    {
        return $user->hasCompanyPermission($appointmentWorker->company_id, 'delete appointment workers');
    }
    ...
    {
        return $user->hasCompanyPermission($appointmentWorker->company_id, 'restore appointment workers');
    }
    ...
    {
        return $user->hasCompanyPermission($appointmentWorker->company_id, 'force delete appointment workers');
    }
}
