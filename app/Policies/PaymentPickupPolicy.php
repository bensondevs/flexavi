...
class PaymentPickupPolicy
{
    ...
    {
        return $user->hasPermissionTo('view any payment pickups');
    }
    ...
    {
        return $user->hasCompanyPermission($appointment->company_id, 'view any payment pickups');
    }
    ...
    {
        return $user->hasCompanyPermission($paymentPickup->company_id, 'view payment pickups');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function create(User $user, Appointment $appointment, Employee $employee)
    {
        if (! $user->hasPermissionTo('create payment pickups')) {
            abort(403, 'You have no permission to create payment pickup.');
        }
    ...
    public function update(
        ...
        if (! $user->hasCompanyPermission($paymentPickup->company_id, 'edit payment pickups')) {
    ...
    public function pickup(User $user, PaymentPickup $paymentPickup)
    {
        ...
        return $user->hasCompanyPermission($companyId, $permissionName);
    }
