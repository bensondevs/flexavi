...
*/
Route::group(
	['prefix' => 'companies', 'middleware' => ['owner']], 
	base_path('routes/api/dashboard/companies.php')
);
...
Route::group(
	...
	base_path('routes/api/dashboard/admin.php')
);
...
Route::group(
	['prefix' => 'customer'], 
	base_path('routes/api/dashboard/customer.php')
);