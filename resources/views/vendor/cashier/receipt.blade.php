                    ...
                    <tr>
                        <td align="center" class="sm-px-16">
                            <table
                                ...
                                width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td>
                                        <table style="text-align:center" width="100%" align="center" cellpadding="0"
                                                        ...
                                                        @foreach($invoice->items() as $item)
                                                            <tr>
                                                                <td colspan="2"
                                                                    ...
                                                                    @if($item->quantity > 1)
                                                                            {{ $item->quantity }}
                                                                            x {{ Laravel\Cashier\Cashier::formatAmount($item->getUnitPrice()) }}
                                                                        @endif
                                                                </span>
                                                                </td>
