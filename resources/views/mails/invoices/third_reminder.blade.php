    ...
    <div class="container-content">
        <div class="card">
            ...
            <p class="card-body-top">
                <span>
                    Beste
                    <b>Simeon Benson</b>, Tot op heden blijft u in gebreke met de betaling van de onderstaande factu(u)r(en), waarvan de betalingstermijn inmiddels ruimschoots is verstreken: <b>F-20220007, 15/10/2022 - €700</b> Voor deze factu(u)r(en) is u eerder al een betalingsherinnering gezonden. Desondanks is betaling nadien uitgebleven. Vriendelijk doch dringend verzoek ik u alsnog zorg te dragen voor betaling. Uw betaling dient uiterlijk binnen 7 dagen na dagtekening van deze brief te zijn bijgeschreven. Betaling dient plaats te vinden op IBAN <b>910-8290-1878</b> ten name van <b>Exclusive Laboratory</b> te <b>Semarang</b> onder vermelding van bovenvermeld(e) factuurnummer(s).
                </span>
                <br/>
                <br>
                <span>
                    Als tijdige betaling onverhoopt uitblijft, zie ik mijzelf helaas genoodzaakt de vordering ter incasso uit
                    handen te geven aan ons incassobureau. In dat geval zal tevens aanspraak worden gemaakt op vergoeding van de
                    verschuldigde rente en buitengerechtelijke incassokosten. Vooralsnog verwacht ik dat het zover niet hoeft te
                    komen en dat u alsnog aan uw financiële verplichtingen zult voldoen.
                    ...
                    Heeft u naar aanleiding hiervan nog vragen, neem dan contact met ons op.
