...
<div class="container">
    ...
    <div class="container-content">
        <div class="card">
            <h3 class="card-title"> Verlies geen werk!</h3>
            ...
            <p class="card-body-top">
                ...
                <br/>
                <span> Vandaag verloopt de gratis trial. Dat betekent dat u na vandaag niet meer kan werken in Flexavi. Wilt u geen werk verliezen en continu gebruik maken van Flexavi, stel dan direct uw account in om geen momentum te verliezen. </span>
                <br>
                <span>Dit kunt u hier doen: </span>
            </p>
