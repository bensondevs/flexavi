...
<head>
    ...
    <title>Betaling nodig voor Flexavi</title>
    <style>
        * {
            padding: 0;
            margin: 0;
...
<div class="container">
    ...
    <div class="container-content">
        <div class="card">
            <h3 class="card-title"> Betaling nodig voor Flexavi </h3>
            ...
            <p class="card-body-top">
                ...
                <br/>
                <span> Uw abonnement verloopt op 19/11/2022. Zorg dat de betaling voor de volgende maand in opgepakt wordt, zodat het werk binnen Flexavi niet stil valt. Heeft u liever automatische betalingen? Stel dan een automatische betaalmethode in zoals een SEPA machtiging of een credit card. </span>
                <br>
                <span>
                    Wilt u uw betaling nu al regelen voor volgende maand, druk dan op onderstaande knop:
                </span>
            </p>
            <a class="card-link-button" href="#">
                <button class="card-button" type="submit"> Betaal Direct</button>
            </a>
