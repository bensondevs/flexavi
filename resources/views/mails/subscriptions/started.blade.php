...
<head>
    ...
    <title>Bedankt voor het activeren van Flexavi</title>
    <style>
        * {
            padding: 0;
            margin: 0;
...
<div class="container">
    ...
    <div class="container-content">
        <div class="card">
            <h3 class="card-title"> Bedankt voor het activeren van Flexavi </h3>
            ...
            <p class="card-body-top">
                ...
                <br/>
                <span> Het abonnement is zojuist van start gegaan met Flexavi. Het abonnement zal maandelijks automatisch geïncasseerd worden of u ontvangt maandelijks een betaalnotificatie. </span>
            </p>
