...
<head>
    ...
    <title>Betaling niet gelukt</title>
    <style>
        * {
            padding: 0;
            margin: 0;
...
<div class="container">
    ...
    <div class="container-content">
        <div class="card">
            <h3 class="card-title"> Betaling niet gelukt </h3>
            ...
            <p class="card-body-top">
                ...
                <br/>
                <span>
                    De betaling voor de volgende periode is niet gelukt. Graag willen we u erop wijzen dat, wanneer de betaling binnen 7 dagen niet gelukt is, we Flexavi stil moeten zetten totdat de betaling gelukt is.
                </span>
                <br>
                <span>
                   U kunt hier betalen:
            ...
            <p class="card-body-bottom">
                <span> Alvast bedankt voor de moeite. </span>
                <br/>
