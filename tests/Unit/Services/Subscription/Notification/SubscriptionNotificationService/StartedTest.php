...
/**
 * @see \App\Services\Subscription\Notification\SubscriptionNotificationService::started()
 *      To the tested service method.
 */
class StartedTest extends SubscriptionNotificationServiceTest
{
    use WithFaker;
    ...
    public function ensure_this_method_pushed_job(): void
    {
        ...
        $this->service()->started($subscription);
