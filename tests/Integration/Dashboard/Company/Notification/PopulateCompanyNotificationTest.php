 ...
 */
class PopulateCompanyNotificationTest extends TestCase
{
    use WithFaker;
    ...
    /**
     * Test populate company notifications where types
     *
     * @return void
     */
    public function test_populate_company_notifications_where_types(): void
    {
    ...
    /**
     * Test populate last 3 days company notifications
     *
     * @return void
     */
    public function test_populate_last_3_days_company_notifications(): void
    {
        $user = User::factory()->owner()->create();
        $user->load(['owner.company']);
        $this->actingAs($user);
    ...
    /**
     * Test populate company notifications by search keyword
     *
     * @return void
     */
    public function test_populate_company_notifications_by_search_keyword(): void
    {
        $user = User::factory()->owner()->create();
        $user->load(['owner.company']);
        $this->actingAs($user);
