...
namespace Tests\Integration\Dashboard\Company\Setting\EmployeeSetting;

use App\Enums\Setting\SettingModule;
use App\Models\User\User;
use Database\Factories\EmployeeSettingFactory;
 ...
 */
class ViewEmployeeSettingTest extends TestCase
{
    use WithFaker;
    ...
    * @const
    */
    public const BASE_MODULE_URL = '/api/dashboard/companies/settings/employee';
    ...
    */
    ...
    private function assertResponseHasSettingResource(TestResponse $response): void
    {
        ...
        $this->assertArrayHasKey('use_initials_when_dont_have_avatar', $setting);
        $this->assertIsBool($setting['use_initials_when_dont_have_avatar']);

        $this->assertArrayHasKey('invitation_expiry', $setting);
        $this->assertIsNumeric($setting['invitation_expiry']);
    }


    /**
    * Test view employee setting
    *
    * @return void
    */
    public function test_view_employee_setting(): void
    {
        $user = $this->authenticate();

        $company = $user->owner->company;

        $module = SettingModule::Employee;
        $setting = EmployeeSettingFactory::new()->create(['company_id' => $company->id]);
    ...
    /**
    * Test view default employee setting
    *
    * @return void
    */
    public function test_view_defult_employee_setting(): void
    {
        $user = $this->authenticate();
